 ...
 * on 2017-07-23 at 09:47:12 UTC 
 * Modify at your own risk.
 */

package com.example.mnageh.myapplication.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  /**
   * Create a request for the method "getOneJoke".
   *
   * This request holds the parameters needed by the myApi server.  After setting any optional
   * parameters, call the {@link GetOneJoke#execute()} method to invoke the remote operation.
   *
   * @return the request
   */
  public GetOneJoke getOneJoke() throws java.io.IOException {
    GetOneJoke result = new GetOneJoke();
    initialize(result);
    return result;
  }

  public class GetOneJoke extends MyApiRequest<com.example.mnageh.myapplication.backend.myApi.model.MyBean> {
     ...
     * parameters, call the {@link GetOneJoke#execute()} method to invoke the remote operation. <p>
     * {@link
     * GetOneJoke#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)}
     * must be called to initialize this instance immediately after invoking the constructor. </p>
     *
     * @since 1.13
     */
    protected GetOneJoke() {
      super(MyApi.this, "GET", REST_PATH, null, com.example.mnageh.myapplication.backend.myApi.model.MyBean.class);
    }
    ...
    @Override
    public GetOneJoke setAlt(java.lang.String alt) {
      return (GetOneJoke) super.setAlt(alt);
    }

    @Override
    public GetOneJoke setFields(java.lang.String fields) {
      return (GetOneJoke) super.setFields(fields);
    }

    @Override
    public GetOneJoke setKey(java.lang.String key) {
      return (GetOneJoke) super.setKey(key);
    }

    @Override
    public GetOneJoke setOauthToken(java.lang.String oauthToken) {
      return (GetOneJoke) super.setOauthToken(oauthToken);
    }

    @Override
    public GetOneJoke setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (GetOneJoke) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public GetOneJoke setQuotaUser(java.lang.String quotaUser) {
      return (GetOneJoke) super.setQuotaUser(quotaUser);
    }

    @Override
    public GetOneJoke setUserIp(java.lang.String userIp) {
      return (GetOneJoke) super.setUserIp(userIp);
    }

    @Override
    public GetOneJoke set(String parameterName, Object value) {
      return (GetOneJoke) super.set(parameterName, value);
    }
  }
  ...
  public class SayHi extends MyApiRequest<com.example.mnageh.myapplication.backend.myApi.model.MyBean> {
    ...
    protected SayHi(java.lang.String name) {
      super(MyApi.this, "POST", REST_PATH, null, com.example.mnageh.myapplication.backend.myApi.model.MyBean.class);
